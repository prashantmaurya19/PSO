...
const Events = {
  ...
  SOCKET_BOARD_MOVE_PLAYED: "SOCKET_BOARD_MOVE_PLAYED",
  ...
  TEST: "TEST",
  PHYSICAL_BOARD_MOVE_PLAYED: "PHYSICAL_BOARD_MOVE_PLAYED",
};

/**
 * @typedef {
  "TEST"
  | "PLAYER_OPONENT_DATA_UPDATED"
  | "PLAYER_DATA_UPDATED"
  | "SOCKET_GAME_EVENT_RECIVED"
  | "SOCKET_GAME_EVENT_SENDED"
  | "SOCKET_GAME_REQUEST_SENDED"
  | "SOCKET_BOARD_MOVE_PLAYED"
  | "GAME_INITIALIZED"
  | "GAME_STARTED"
  | "GAME_ENDED"
  | "BOARD_PROMOTION_PIECE_SELECTED"
  | "BOARD_MOVE_PLAYED"
  | "PHYSICAL_BOARD_MOVE_PLAYED"
  } EventName
 */
